...
<head>
    ...
    <title>Política de Privacidade e Termos de Uso - PalpiteiroFC</title>
...
<body class="bg-light text-dark">
    <div class="container mt-5">
        ...
        <section id="privacy-policy" class="mb-5">
            ...
            <p class="lead">Bem-vindo ao PalpiteiroFC! Nós respeitamos a sua privacidade e estamos comprometidos em proteger suas informações pessoais. Esta Política de Privacidade descreve como coletamos, usamos, e protegemos seus dados ao utilizar nosso site e serviços.</p>

            <h3 class="mt-4">1. Introdução</h3>
            <p>Esta Política de Privacidade aplica-se a todos os usuários do PalpiteiroFC. Ao utilizar nosso site, você concorda com a coleta e uso das informações conforme descrito neste documento.</p>

            <h3 class="mt-4">2. Coleta de Informações</h3>
            <p>Coletamos informações pessoais como nome, email e número de telefone durante o cadastro. Também podemos coletar dados adicionais, como endereço IP, comportamento de navegação e dados de dispositivo, para melhorar sua experiência e prevenir fraudes.</p>
        ...
        <section id="terms-of-service">
            ...
            <p class="lead">Ao utilizar o PalpiteiroFC, você concorda com os Termos de Uso estabelecidos neste documento. Se você não concorda com algum termo, deve cessar o uso do site imediatamente.</p>

            <h3 class="mt-4">1. Aceitação dos Termos</h3>
            <p>Ao utilizar o PalpiteiroFC, você concorda em seguir as regras estabelecidas nestes Termos de Uso.</p>

            <h3 class="mt-4">2. Cadastro e Conta de Usuário</h3>
            <p>Cada usuário deve criar uma conta única utilizando informações verdadeiras e precisas. O uso de múltiplas contas para obtenção de créditos gratuitos é estritamente proibido e constitui fraude. Violação desta regra poderá resultar na suspensão ou encerramento de todas as contas envolvidas, e os usuários infratores podem ser responsabilizados legalmente.</p>

            <h3 class="mt-4">3. Créditos e Uso do Serviço</h3>
            <p>O PalpiteiroFC oferece créditos gratuitos durante o cadastro inicial para que você possa testar nossos serviços. Os créditos são limitados a uma única conta por usuário. Tentativas de burlar esse sistema para obter mais créditos são consideradas fraude e poderão resultar em sanções legais.</p>

            <h3 class="mt-4">4. Responsabilidade sobre Palpites</h3>
            <p>Os palpites fornecidos pelo PalpiteiroFC são baseados em análise de dados e não garantem a precisão dos resultados. Os usuários são responsáveis por suas próprias decisões e ações, e o PalpiteiroFC não se responsabiliza por quaisquer perdas financeiras ou de outra natureza decorrentes do uso dos palpites fornecidos.</p>

            <h3 class="mt-4">5. Uso Adequado do Site</h3>
            <p>Você concorda em utilizar o PalpiteiroFC de maneira responsável e conforme as leis aplicáveis. Qualquer tentativa de manipular, hackear ou explorar o site de maneira indevida resultará em ações legais contra o infrator.</p>
            ...
            <p>Estes Termos de Uso são regidos pelas leis brasileiras. Qualquer disputa relacionada ao uso do PalpiteiroFC será resolvida nos tribunais competentes da cidade onde a empresa está sediada.</p>
        </section>
